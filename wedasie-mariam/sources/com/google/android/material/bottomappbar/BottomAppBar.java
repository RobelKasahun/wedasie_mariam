...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
            ...
            public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                ...
                if (bottomAppBar.setFabDiameter(Behavior.this.fabContentRect.height())) {
                    ...
                    if (layoutParams.bottomMargin == 0) {
                        layoutParams.bottomMargin = Math.max(bottomAppBar.getBottomInset(), bottomAppBar.getResources().getDimensionPixelOffset(R.dimen.mtrl_bottomappbar_fab_bottom_margin) - ((floatingActionButton.getMeasuredHeight() - Behavior.this.fabContentRect.height()) / 2));
                    }
                }
            }
        };
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, BottomAppBar bottomAppBar, int i) {
            ...
            View access$1600 = bottomAppBar.findDependentView();
            if (access$1600 != null && !ViewCompat.isLaidOut(access$1600)) {
                ((CoordinatorLayout.LayoutParams) access$1600.getLayoutParams()).anchorGravity = 49;
                if (access$1600 instanceof FloatingActionButton) {
                    FloatingActionButton floatingActionButton = (FloatingActionButton) access$1600;
