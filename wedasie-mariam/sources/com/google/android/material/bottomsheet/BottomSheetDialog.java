...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    public void cancel() {
        ...
        BottomSheetBehavior.BottomSheetCallback bottomSheetCallback2 = behavior2.getBottomSheetCallback();
        BottomSheetBehavior.BottomSheetCallback bottomSheetCallback3 = this.bottomSheetCallback;
        if (bottomSheetCallback2 != bottomSheetCallback3) {
            behavior2.setBottomSheetCallback(bottomSheetCallback3);
        }
