...
class MaterialButtonHelper {
    ...
    public void loadFromAttributes(TypedArray typedArray) {
        ...
        if (typedArray.hasValue(R.styleable.MaterialButton_cornerRadius)) {
            ...
            setShapeAppearanceModel(this.shapeAppearanceModel.withCornerRadius((float) this.cornerRadius));
    ...
    private Drawable createBackground() {
        ...
        if (IS_LOLLIPOP) {
            ...
            if (i > 0) {
                ShapeAppearanceModel adjustShapeAppearanceModelCornerRadius = adjustShapeAppearanceModelCornerRadius(this.shapeAppearanceModel, ((float) i) / 2.0f);
                materialShapeDrawable.setShapeAppearanceModel(adjustShapeAppearanceModelCornerRadius);
                materialShapeDrawable2.setShapeAppearanceModel(adjustShapeAppearanceModelCornerRadius);
                ((MaterialShapeDrawable) this.maskDrawable).setShapeAppearanceModel(adjustShapeAppearanceModelCornerRadius);
            }
    ...
    private void updateStroke() {
        ...
        if (materialShapeDrawable != null) {
            ...
            if (IS_LOLLIPOP) {
                ShapeAppearanceModel adjustShapeAppearanceModelCornerRadius = adjustShapeAppearanceModelCornerRadius(this.shapeAppearanceModel, ((float) this.strokeWidth) / 2.0f);
                updateButtonShape(adjustShapeAppearanceModelCornerRadius);
                Drawable drawable = this.maskDrawable;
                if (drawable != null) {
                    ((MaterialShapeDrawable) drawable).setShapeAppearanceModel(adjustShapeAppearanceModelCornerRadius);
                }
            }
        }
    }
    ...
    public void setCornerRadius(int i) {
        if (!this.cornerRadiusSet || this.cornerRadius != i) {
            this.cornerRadius = i;
            this.cornerRadiusSet = true;
            setShapeAppearanceModel(this.shapeAppearanceModel.withCornerRadius(((float) i) + (((float) this.strokeWidth) / 2.0f)));
        }
    }
    ...
    private ShapeAppearanceModel adjustShapeAppearanceModelCornerRadius(ShapeAppearanceModel shapeAppearanceModel2, float f) {
        return shapeAppearanceModel2.withAdjustedCorners(f);
    }
