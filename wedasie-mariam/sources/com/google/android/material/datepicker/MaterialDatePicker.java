...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    static <S> MaterialDatePicker<S> newInstance(Builder<S> builder) {
        ...
        bundle.putParcelable(GRID_SELECTOR_KEY, builder.dateSelector);
    ...
    public final void onSaveInstanceState(Bundle bundle) {
        ...
        bundle.putParcelable(CALENDAR_CONSTRAINTS_KEY, new CalendarConstraints.Builder(this.calendarConstraints).setOpening(this.calendar.getCurrentMonth()).build());
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (this.fullscreen) {
            findViewById.setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            findViewById.setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), getDialogPickerHeight(context)));
        }
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            window.setBackgroundDrawable(new InsetDrawable(this.background, dimensionPixelOffset));
            window.getDecorView().setOnTouchListener(new InsetDialogOnTouchListener(requireDialog(), new Rect(dimensionPixelOffset, dimensionPixelOffset, dimensionPixelOffset, dimensionPixelOffset)));
        }
        startPickerFragment();
    }
    ...
    public static final class Builder<S> {
        ...
        public Builder<S> setTitleTextResId(int i) {
