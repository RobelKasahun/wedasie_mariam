...
public class RangeDateSelector implements DateSelector<Pair<Long, Long>> {
    ...
    public void setSelection(Pair<Long, Long> pair) {
        ...
        if (pair.first == null) {
            ...
            l = Long.valueOf(DateLongs.canonicalYearMonthDay(((Long) pair.first).longValue()));
        }
        this.selectedStartItem = l;
        if (pair.second != null) {
            l2 = Long.valueOf(DateLongs.canonicalYearMonthDay(((Long) pair.second).longValue()));
        }
    ...
    public int getDefaultThemeResId(Context context) {
        ...
        return MaterialAttributes.resolveOrThrow(context, resources.getDisplayMetrics().widthPixels > resources.getDimensionPixelSize(R.dimen.mtrl_calendar_maximum_default_fullscreen_width) ? R.attr.materialCalendarTheme : R.attr.materialCalendarFullscreenTheme, MaterialDatePicker.class.getCanonicalName());
    }
    ...
    public View onCreateTextInputView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, CalendarConstraints calendarConstraints, OnSelectionChangedListener<Pair<Long, Long>> onSelectionChangedListener) {
        ...
        AnonymousClass1 r0 = new DateFormatTextWatcher(str, simpleDateFormat, textInputLayout, calendarConstraints2) {
