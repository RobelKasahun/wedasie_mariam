...
public class SingleDateSelector implements DateSelector<Long> {
    ...
    public void setSelection(Long l) {
        this.selectedItem = l == null ? null : Long.valueOf(DateLongs.canonicalYearMonthDay(l.longValue()));
    }
    ...
    public View onCreateTextInputView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, CalendarConstraints calendarConstraints, OnSelectionChangedListener<Long> onSelectionChangedListener) {
        ...
        editText.addTextChangedListener(new DateFormatTextWatcher(string, simpleDateFormat, textInputLayout, calendarConstraints) {
    ...
    public String getSelectionDisplayString(Context context) {
        ...
        String yearMonthDay = DateStrings.getYearMonthDay(new Date(l.longValue()), Locale.getDefault());
