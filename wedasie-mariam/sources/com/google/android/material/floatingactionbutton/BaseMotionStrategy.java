...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public AnimatorSet createAnimator(MotionSpec motionSpec2) {
        ...
        if (motionSpec2.hasPropertyValues("cornerRadius") && this.fab.isUsingPillCorner()) {
            arrayList.add(motionSpec2.getAnimator("cornerRadius", this.fab, ExtendedFloatingActionButton.CORNER_RADIUS));
        }
