...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    static final Property<View, Float> CORNER_RADIUS = new Property<View, Float>(Float.class, "cornerRadius") {
        public void set(View view, Float f) {
            ExtendedFloatingActionButton extendedFloatingActionButton = (ExtendedFloatingActionButton) view;
            extendedFloatingActionButton.setShapeAppearanceModel(extendedFloatingActionButton.getShapeAppearanceModel().withCornerRadius((float) f.intValue()));
        }
    ...
    public ExtendedFloatingActionButton(Context context, AttributeSet attributeSet, int i) {
        ...
        setShapeAppearanceModel(ShapeAppearanceModel.builder(context, attributeSet, i, DEF_STYLE_RES, -1).build());
    }
    ...
    private ShapeAppearanceModel createPillCornerShapeAppearance() {
        return getShapeAppearanceModel().withCornerRadius((float) getAdjustedRadius(getMeasuredHeight()));
    }
