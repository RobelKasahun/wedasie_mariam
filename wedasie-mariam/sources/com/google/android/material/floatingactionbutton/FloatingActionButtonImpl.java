...
class FloatingActionButtonImpl {
    ...
    public final void setShapeAppearance(ShapeAppearanceModel shapeAppearanceModel, boolean z) {
        if (z) {
            shapeAppearanceModel = shapeAppearanceModel.withCornerRadius((float) (this.view.getSizeDimension() / 2));
        }
    ...
    public void updateSize() {
        ...
        if (this.usingDefaultCorner && this.shapeDrawable != null && (shapeAppearanceModel = this.shapeAppearance) != null) {
            setShapeAppearance(shapeAppearanceModel.withCornerRadius(((float) this.view.getSizeDimension()) / 2.0f), this.usingDefaultCorner);
        }
    }
    ...
    public MaterialShapeDrawable createShapeDrawable() {
        ...
        if (this.usingDefaultCorner) {
            shapeAppearanceModel = shapeAppearanceModel.withCornerRadius(((float) this.view.getSizeDimension()) / 2.0f);
        }
