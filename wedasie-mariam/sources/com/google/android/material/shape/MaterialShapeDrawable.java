...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    public void setCornerRadius(float f) {
        setShapeAppearanceModel(this.drawableState.shapeAppearanceModel.withCornerRadius(f));
    }
    ...
    private void calculateStrokePath() {
        this.strokeShapeAppearance = getShapeAppearanceModel().withAdjustedCorners(-getStrokeInsetLength());
