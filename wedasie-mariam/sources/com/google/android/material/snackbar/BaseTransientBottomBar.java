...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    private final Runnable bottomMarginGestureInsetRunnable = new Runnable() {
        public void run() {
            int access$000 = BaseTransientBottomBar.this.getScreenHeight() - BaseTransientBottomBar.this.getViewAbsoluteBottom();
            if (access$000 < BaseTransientBottomBar.this.extraBottomMarginGestureInset) {
                ((ViewGroup.MarginLayoutParams) BaseTransientBottomBar.this.view.getLayoutParams()).bottomMargin += BaseTransientBottomBar.this.extraBottomMarginGestureInset - access$000;
    ...
    public void updateBottomMargin() {
        ((ViewGroup.MarginLayoutParams) this.view.getLayoutParams()).bottomMargin = this.originalBottomMargin + (this.anchorView != null ? this.extraBottomMarginAnchorView : this.extraBottomMarginWindowInset);
    ...
    private boolean shouldUpdateGestureInset() {
        return this.extraBottomMarginGestureInset > 0 && !this.ignoreGestureInsetBottom && isSwipeDismissable();
    }
    ...
    public void setIgnoreGestureInsetBottom(boolean z) {
        this.ignoreGestureInsetBottom = z;
    }

    public boolean isIgnoreGestureInsetBottom() {
        return this.ignoreGestureInsetBottom;
    }
